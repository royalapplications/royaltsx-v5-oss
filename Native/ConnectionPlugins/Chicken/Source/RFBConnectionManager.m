...
- (IBAction)addServer:(id)sender
{
	...
	id<IServerData> newServer = [serverDataManager createServerByName:ChickenVncFrameworkLocalizedString(@"RFBDefaultServerName", nil)];
...
- (int)numberOfRowsInTableView:(NSTableView *)aTableView
{
	...
	{
		return (int)[mOrderedServerNames count];
	}
