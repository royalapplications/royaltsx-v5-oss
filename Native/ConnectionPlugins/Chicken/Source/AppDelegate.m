...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	[mInfoVersionNumber setStringValue: [[ChickenVncFrameworkBundle() infoDictionary] objectForKey: @"CFBundleVersion"]];
}
...
{
	NSString *path = [ChickenVncFrameworkBundle() pathForResource: @"index" ofType: @"html" inDirectory: @"help"];
