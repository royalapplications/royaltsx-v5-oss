...
- (id)initWithNetService:(NSNetService*)service
{
	...
	if (self)
	{
        ...
        [_host autorelease];
        _host = [ChickenVncFrameworkLocalizedString(@"Resolving", nil) retain];
...
- (void)netService:(NSNetService *)sender didNotResolve:(NSDictionary *)errorDict
{
	...
	bResloveSucceeded = NO;
    [_host autorelease];
	_host = [ChickenVncFrameworkLocalizedString(@"AddressResolveFailed", nil) retain];
...
- (void)extractAddress
{
    ...
    [self setHost: ChickenVncFrameworkLocalizedString( @"AddressResolveFailed", nil )];
}
